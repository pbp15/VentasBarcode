...
class IngresoController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($buscar==''){
            ...
            'ingresos.num_comprobante','ingresos.fecha_hora','ingresos.impuesto','ingresos.total',
            'ingresos.estado','personas.nombre','users.usuario')
            ->where('ingresos.'.$criterio, 'like', '%'. $buscar . '%')->orderBy('ingresos.id', 'desc')->paginate(15);
        }
...
public function pdfIngresoTotal(){

    $ingresoTotal = Ingreso::join('personas','ingresos.idproveedor','=','personas.id')
        ->join('users','ingresos.idusuario','=','users.id')
        ->select('ingresos.id','ingresos.tipo_comprobante','ingresos.num_comprobante','ingresos.fecha_hora',
        ...
        $cont=Ingreso::where('ingresos.estado', 'Registrado')
        ->count();
        
        $total= DB::table('ingresos as i')

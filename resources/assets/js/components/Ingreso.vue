                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                ...
                                <button type="button" @click="IngresoTotalPdf()" class="btn btn-info">
    ...
    export default {
        ...
        methods : {
            ...
            pdfIngreso(id){
                ...
                window.open('http://127.0.0.1:8000/ingreso/pdfIngreso/' + id + ',' + '_blank');
                

            },
            
            IngresoTotalPdf(){
                 window.open('http://127.0.0.1:8000/ingreso/pdfIngresoTotal','_blank');

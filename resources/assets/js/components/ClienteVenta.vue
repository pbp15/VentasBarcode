...
export default {
  ...
  methods: {
    ...
    validarPersona() {
      ...
      if (this.phone.lenght != 9)
        this.errorMostrarMsjPersona.push("Ingresar  9 digitos al Telf ");
